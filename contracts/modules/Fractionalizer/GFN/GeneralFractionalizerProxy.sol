...
import "../../../storage/modules/ModuleStorage.sol";
 ...
 /**
 * @title General NFT fractionalizer proxy
 */
contract GeneralFractionalizerProxy is GeneralFractionalizerStorage, ModuleStorage, Pausable, ReentrancyGuard, OwnedUpgradeabilityProxy {
     /**
    * @notice Constructor
