...
interface ISTFactory {
     ...
     * @param tokenName is the name of the Security token
     * @param tokenSymbol is the symbol of the Security Token
     * @param tokenDecimals is the number of decimals of the Security Token
